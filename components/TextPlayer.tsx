...
function TextPlayer({ text, language }: IProps) {
  ...
  return (
    <button
      disabled={text === ""}
      tw="shadow-md text-sm lg:text-base disabled:(opacity-50 cursor-not-allowed) transition-opacity duration-300 border text-white rounded-lg w-min px-4 lg:px-6 py-2 focus:(border-transparent ring-2 outline-none)"
